...
class WalletBackupTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.stop_four()
        for n in xrange(4):
            os.unlink(os.path.join(tmpdir,"node%s" % n,"regtest","btcfork.conf"))
        ...
        os.unlink(os.path.join(tmpdir,"node2","regtest","btcfork.conf"))
        self.start_four()
        ...
        os.unlink(os.path.join(tmpdir,"node1","regtest","btcfork.conf"))
