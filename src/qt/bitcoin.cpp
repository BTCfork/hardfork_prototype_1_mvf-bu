...
int main(int argc, char *argv[])
{
    ...
    try
    {
        ...
        WinShutdownMonitor::registerShutdownBlockReason(QObject::tr("Bitcoin MVF-Core didn't yet exit safely..."), (HWND)app.getMainWinId());  // MVF-BU client name change (MVHF-BU-SW-REQ-11-1 / MVHF-BU-DES-IDME-2)
#endif
        app.exec();
        app.requestShutdown();
        app.exec();
